...
describe('normalize-url', () => {
  test('main', () => {
    expect(normalizeUrl('http://sindresorhus.com')).toBe('https://sindresorhus.com')
    expect(normalizeUrl('http://sindresorhus.com ')).toBe('https://sindresorhus.com')
    expect(normalizeUrl('http://sindresorhus.com.')).toBe('https://sindresorhus.com')
    expect(normalizeUrl('http://SindreSorhus.com')).toBe('https://sindresorhus.com')
    expect(normalizeUrl('http://sindresorhus.com')).toBe('https://sindresorhus.com')
    ...
    // expect(normalizeUrl('//sindresorhus.com')).toBe('https://sindresorhus.com')

    expect(normalizeUrl('http://sindresorhus.com')).toBe('https://sindresorhus.com')
    expect(normalizeUrl('http://sindresorhus.com:80')).toBe('https://sindresorhus.com')
    expect(normalizeUrl('https://sindresorhus.com:443')).toBe('https://sindresorhus.com')
    expect(normalizeUrl('ftp://sindresorhus.com:21')).toBe('ftp://sindresorhus.com')
    expect(normalizeUrl('https://sindresorhus.com/foo/')).toBe('https://sindresorhus.com/foo')
    ...
    expect(normalizeUrl('https://sindresorhus.com/%7Efoo/')).toBe('https://sindresorhus.com/~foo')
    expect(normalizeUrl('https://sindresorhus.com/?')).toBe('https://sindresorhus.com')
    expect(normalizeUrl('https://\u00eaxample.com')).toBe('https://xn--xample-hva.com')
    expect(normalizeUrl('https://sindresorhus.com/?b=bar&a=foo')).toBe(
    ...
    expect(normalizeUrl('https://sindresorhus.com:5000')).toBe('https://sindresorhus.com:5000')
    expect(normalizeUrl('https://sindresorhus.com/foo#bar')).toBe(
  ...
  test('removeTrailingSlash and removeDirectoryIndex options', () => {
    expect(normalizeUrl('https://sindresorhus.com/path/')).toBe('https://sindresorhus.com/path')
  ...
  test('invalid urls', () => {
    ...
    expect(() => normalizeUrl('/relative/path/')).toThrow('Invalid URL: /relative/path/')
  })
  ...
  test('remove duplicate pathname slashes', () => {
    ...
    expect(normalizeUrl('ftp://sindresorhus.com//foo')).toBe('ftp://sindresorhus.com/foo')
